...
class SpielansichtStationQuizTwoScreen extends StatefulWidget {
  const SpielansichtStationQuizTwoScreen({Key? key}) : super(key: key);

  @override
  _SpielansichtStationQuizTwoScreenState createState() =>
      _SpielansichtStationQuizTwoScreenState();
}

class _SpielansichtStationQuizTwoScreenState
    extends State<SpielansichtStationQuizTwoScreen> {
...
//Methode zum Überprüfen der Antworten
  void checkAnswersAndNavigate(BuildContext context) {
    if (selectedAnswerQuestion1 == "D" && selectedAnswerQuestion2 == "A") {
      ...
      print('Geschafft');
      isSchillerparkStationCompletedTourist = true;
      print(isSchillerparkStationCompletedTourist);
    } else {
