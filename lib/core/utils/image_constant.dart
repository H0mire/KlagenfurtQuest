class ImageConstant {
  ...
  static String imgBtnlocate = '$imagePath/img_btnlocate.svg';
  ...
  static String imgImgpreview131x131 = '$imagePath/img_imgpreview_131x131.png';

  static String imgDone = '$imagePath/img_done.png';

  static String imgSpielansichtQuiz = '$imagePath/img_spielansicht_quiz.png';
